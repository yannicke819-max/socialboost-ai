  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a:
          "Génération sur les 5 dès le Pro. Publication automatique : LinkedIn d'abord (Sprint 6), puis Instagram, puis X et TikTok. En attendant, copier-coller en un clic depuis le Studio.",
      },
      {
